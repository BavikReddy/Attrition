...
if __name__=='__main__':
    ...
    hyperparameter_tuning_path=os.path.join(base_dir,'hyperparameter_tuning_expresscheck',filename_hyperparameter)
    ...
    feature_dict_path = f"{base_dir}/feature_dict_expresscheck/feature_dict_expresscheck.json"
    ...
    x_train=full_df_express[req_features]
    ...
    # save the model
    with open(os.path.join(base_dir,'expresscheck_model', 'expresscheck_model.pkl'), 'wb') as out:
        pickle.dump(model, out)
    # save_path = os.path.join(base_dir,'expresscheck_model', 'expresscheck_model.sav')
    # joblib.dump(model, save_path)
    
    # save a copy
    today = date.today()
    archive_file_name = 'expresscheck_model-' + str(today) + '.pkl'
    
    with open(os.path.join(base_dir,'expresscheck_model_archive', archive_file_name), 'wb') as out:
        pickle.dump(model, out)
