...
if __name__=='__main__':
    ...
    hyperparameter_tuning_path=os.path.join(base_dir,'hyperparameter_tuning_smallfleet',filename_hyperparameter)
    ...
    feature_dict_path = f"{base_dir}/feature_dict_smallfleet/feature_dict_smallfleet.json"
    ...
    x_train=full_df_small[req_features]
    ...
    # save_path = os.path.join(base_dir,'smallfleet_model', 'smallfleet_model.sav')
    with open(os.path.join(base_dir,'smallfleet_model', 'smallfleet_model.pkl'), 'wb') as out:
        pickle.dump(model, out)
        
    # save a copy
    today = date.today()
    archive_file_name = 'smallfleet_model-' + str(today) + '.pkl'
    
    with open(os.path.join(base_dir,'smallfleet_model_archive', archive_file_name), 'wb') as out:
        pickle.dump(model, out)
